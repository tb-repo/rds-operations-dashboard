...
from shared.aws_clients import get_dynamodb_client, get_s3_client, get_cloudwatch_client
...
def store_cost_data(
    ...
    try:
        ...
        logger.warning(f"Cost snapshots table not found: {table_name}. Skipping storage.")
    except Exception as e:
