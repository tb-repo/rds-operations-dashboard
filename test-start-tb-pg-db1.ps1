...
# Test Start Operation on tb-pg-db1
$ErrorActionPreference = "Stop"

Write-Host "Testing Start Operation on tb-pg-db1..." -ForegroundColor Cyan

# Test with start_instance operation on tb-pg-db1 (which is stopped)
$payload = @{
    body = @{
